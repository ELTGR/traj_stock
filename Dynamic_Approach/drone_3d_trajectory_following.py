...
def quad_sim(x_c, y_c, z_c, taille, px, py, pz, gx, gy, gz, xob, yob, zob):
    """
    ...
    q = Quadrotor( mx, my, mz, gx, gy, gz, xob, yob, zob, x=x_pos, y=y_pos, z=z_pos, roll=roll,
    ...
    while True:
        while t <= T:
            ...
            q.update_pose(x_pos, y_pos, z_pos, roll, pitch, yaw, mx, my, mz, gx, gy, gz, xob, yob, zob)
...
def Drone(px, py, pz, gx, gy, gz, xob, yob, zob):
    """
    ...
    quad_sim(x_coeffs, y_coeffs, z_coeffs,taille, px, py, pz, gx, gy, gz, xob, yob, zob)
