...
def planning_animation3d(ox, oy,oz, resolution):  # pragma: no cover
    #animation in 3D with Z constent
    px, py = planning(ox, oy, resolution)
...
def main(ox,oy,oz, resolution):  # pragma: no cover
    ...
    #ox = [5,  10.0,  20, 25, 20, 10.0, 5]
    #oy = [0.0, 10, 10, 0, -10, -10, 0.0]
    #oz = [20]
    #resolution = 2
    #ox = [0.0, 50.0, 200.0, 130.0, 20, 0.0]
    #oy = [0.0, 0.0, 30.0, 60.0, 80.0, 0.0]
    #oz = [20]
    #resolution = 10


    #planning_animation3d(ox, oy, oz, resolution)
